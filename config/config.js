...
//    db: 'mongodb://localhost/talent', // 数据库连接字符串
    ...
    root: rootPath, // 系统根路径
//    uploadDir: '/data/talnet/uploads', // 文件上传的目录 ： 不能放在应用目录下面 防止应用更新时被误删
    uploadDir: 'I:\\talnet\\uploads', // 文件上传的目录 ： 不能放在应用目录下面 防止应用更新时被误删
    app: {
        domain: "127.0.0.1:3000", name: 'JD.com' // 项目名字
