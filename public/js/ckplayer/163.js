...
function ckstyle(){//定义总的风格
    ...
    ck.pm_ctbar = '1,2,0,-31,0,31,0,0,2000';
    ...
    ck.pm_sch = '1,2,0,-36,0,5,0,0,0';
    //进度条的参数，这里分二种情况，前面7个参数对照控制栏的，第8个参数是拖动按钮的宽，第9个参数是拖动按钮的高
    ck.pm_play = '0,2,0,-31';
    //播放和暂停按钮的坐标
    ck.pm_clock = '0,2,54,-26,110';
    //已播放时间的坐标和宽度
    ck.pm_clock2 = '0,2,54,-26,110';
    //总时间的坐标和宽度
    ck.pm_full = '2,2,-45,-31';
    //全屏和取消全屏按钮的坐标
    ck.pm_vol = '2,2,-90,-31,35,31,5,31';
    //音量调节框的坐标，宽度，高度，拖动按钮的宽度,高度
    ck.pm_sound = '2,2,-102,-31';
    //静音和取消静音的坐标
    ...
    ck.pm_advtime = '260,2,265,5';
    //前置广告倒计时文本宽,对齐方式,x,y
    ck.pm_advmarquee = '1,1,2,5,-56,20,20,0,0,15,3000,1,20,0x000000';
    ...
    ck.pm_buffer = '25,20,0,5,{font color="#fdfdfd" face="arial"}[$buffer]%{/font}';
    ...
    ck.pr_clock2 = '{font color="#fdfdfd" size="12" face="arial"}[$Time] ~ [$TimeAll]{/font}';
    //同pr_clock,这二个是相等的，主要是为了方便在不同的地方调用已播放时间和总时间
    ck.pr_adv = '{font color="#FFFFFF" size="12" face="arial"}点击下方广告，了解更多信息，广告还剩：{font color="#dee309"}{b}[$Second]{/b}{/font} 秒{/font}';
